...
const habits = [
  { name: "Exercise (Cardio/Weights)", progress: 85, isLow: false },
  { name: "Reading (30 mins)", progress: 62, isLow: false },
  { name: "Meditation", progress: 94, isLow: false },
  { name: "Water Intake (2L)", progress: 45, isLow: true },
]
